...
async def start(_, message: types.Message):
    ...
    if private:
        loading_1 = await message.reply_text("<b>⚡ ʟOᴀᴅɪɴɢ...</b>")
    ...
    await message.reply_video(
        video=config.START_VIDEO,  # নিশ্চিত করুন আপনার config.py ফাইলে সঠিক ও সচল ভিডিওর ডিরেক্ট লিংক দেওয়া আছে
        caption=_text,
        reply_markup=key
    )
...
async def start(_, message: types.Message):
    ...
    if private:
        ...
        await loading_1.edit_text("<b>🚀 ꜱᴛᴀʀᴛɪɴɢ ʙᴏᴛ...</b>")
        await asyncio.sleep(0.3)
        await loading_1.edit_text("<b>🔥 ʙᴏᴛ is ᴀʟɪᴠᴇ ɴᴏᴡ!</b>")
        await asyncio.sleep(0.5)
        await loading_1.edit_text("<b>✨ ʙᴏᴛ ʀᴇᴀᴅʏ ✨</b>")
        await asyncio.sleep(0.5)
        await loading_1.delete()
